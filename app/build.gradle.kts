...
android {
    namespace = "com.android.example.eventpop"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.android.example.eventpop"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Direct foundation + layout so runtime matches compiler (avoids NoSuchMethodError on FlowRow / lazy APIs if transitives skew).
    ...
    implementation("io.ktor:ktor-client-android:3.0.0") // Needed for Supabase client
